...
SmartModelMakerGL <- function(named_list_of_parameters=NULL){
...
if (named_list_of_parameters$model_type                     == "RCB_mlsr_BLUE" & 
  ...
  asreml_fixed_formula <- paste0(response_variable_name," ~ 1 + ",
                                         treatment_factor1_name)
  asreml_random_formula <- paste0("~ ",blocking_factor2_name)  # TPS blocking_factor1_name = loc name or something like field id
  DSR_formula <- paste0(asreml_fixed_formula, gsub("~","+",asreml_random_formula))
  # DSR_formula <- formula(paste0(response_variable_name," ~ 1 + ",
  #                               treatment_factor1_name," + ",
  #                               blocking_factor1_name)) 
}
...
if (named_list_of_parameters$model_type                     == "RCB_mlmr_BLUE" & 
  ...
  asreml_fixed_formula <- paste0(response_variable_name," ~ 1 + ",
                                         treatment_factor1_name)
  asreml_random_formula <- paste0("~",blocking_factor1_name," + ",
